...
Game::Game() {
	...
	images = IMG_LoadTexture(render, "../res/pictures/asd.png");
...
void Game::Render_OptionBar() {
	...
	text->Render_Text_Medium("5", TooMuchBombs(5) ? GREY : bombsOption == 1 ? RED : WHITE, 185, 40);

	text->Render_Text_Medium("20", TooMuchBombs(20) ? GREY : bombsOption == 2 ? RED : WHITE, 235, 40);

	text->Render_Text_Medium("40", TooMuchBombs(40) ? GREY : bombsOption == 3 ? RED : WHITE, 280, 40);

	text->Render_Text_Medium("80", TooMuchBombs(80) ? GREY : bombsOption == 4 ? RED : WHITE, 325, 40);

	text->Render_Text_Medium("100", TooMuchBombs(100) ? GREY : bombsOption == 5 ? RED : WHITE, 185, 65);

	text->Render_Text_Medium("200", TooMuchBombs(200) ? GREY : bombsOption == 6 ? RED : WHITE, 235, 65);

	text->Render_Text_Medium("300", TooMuchBombs(300) ? GREY : bombsOption == 7 ? RED : WHITE, 280, 65);
	...
	text->Render_Text_Medium("60", timeOption == 1 ? RED : WHITE, 400, 40);

	text->Render_Text_Medium("180", timeOption == 2 ? RED : WHITE, 450, 40);

	text->Render_Text_Medium("300", timeOption == 3 ? RED : WHITE, 400, 65);

	text->Render_Text_Medium("600", timeOption == 4 ? RED : WHITE, 450, 65);
