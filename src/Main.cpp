				...
				case SDL_MOUSEBUTTONDOWN:
					...
					if (event.button.button == SDL_BUTTON_LEFT) {
						if (y < 100) {
							...
							//NumberOfBombs -> 5
							else if (game->option && !game->start && rangeXY(185, x, 210, 46, y, 63) && !game->TooMuchBombs(50)) {
								Change_BombsNumber(game, sound, 5, 1);
							}
							//NumberOfBombs -> 20
							else if (game->option && !game->start && rangeXY(235, x, 260, 46, y, 63) && !game->TooMuchBombs(20)) {
								Change_BombsNumber(game, sound, 20, 2);
							}
							//NumberOfBombs -> 40
							else if (game->option && !game->start && rangeXY(281, x, 305, 46, y, 63) && !game->TooMuchBombs(40)) {
								Change_BombsNumber(game, sound, 40, 3);
							}
							//NumberOfBombs -> 80
							else if (game->option && !game->start && rangeXY(328, x, 363, 46, y, 63) && !game->TooMuchBombs(80)) {
								Change_BombsNumber(game, sound, 80, 4);
							}
							//NumberOfBombs -> 100
							else if (game->option && !game->start && rangeXY(186, x, 223, 71, y, 88) && !game->TooMuchBombs(100)) {
								Change_BombsNumber(game, sound, 100, 5);
							}
							//NumberOfBombs -> 200
							else if (game->option && !game->start && rangeXY(236, x, 272, 71, y, 88) && !game->TooMuchBombs(200)) {
								Change_BombsNumber(game, sound, 200, 6);
							}
							//NumberOfBombs -> 300
							else if (game->option && !game->start && rangeXY(280, x, 318, 71, y, 88) && !game->TooMuchBombs(300)) {
								Change_BombsNumber(game, sound, 300, 7);
							}
							//NumberOfBombs -> 500
